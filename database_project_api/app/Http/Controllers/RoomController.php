...
class RoomController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $affiliationsQuery = Affiliation::query();
        ...
        if (! $isAdminRoomPage) {
            ...
            $affiliationsQuery->whereIn('id', $visibleAffiliationIds);
        }

        $affiliations = $affiliationsQuery
            ->orderBy('name')
            ->get()
    ...
    /**
     * Prepare room data for API responses.
     */
